...
/**
 * Generated from protobuf message <code>zitadel.management.v1.RemoveProjectGrantMemberRequest</code>
 */
class RemoveProjectGrantMemberRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $grant_id = '';
    /**
     * Generated from protobuf field <code>string user_id = 3 [json_name = "userId", (.validate.rules) = {</code>
     */
    protected $user_id = '';
