...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateGenericOIDCProviderRequest</code>
 */
class UpdateGenericOIDCProviderRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $issuer = '';
    /**
     * Generated from protobuf field <code>string client_id = 4 [json_name = "clientId", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $client_id = '';
    /**
     * client_secret will only be updated if provided
     *
     * Generated from protobuf field <code>string client_secret = 5 [json_name = "clientSecret", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    /**
     * Generated from protobuf field <code>bool is_id_token_mapping = 8 [json_name = "isIdTokenMapping"];</code>
     */
    protected $is_id_token_mapping = false;
    /**
     * Enable the use of Proof Key for Code Exchange (PKCE) for the OIDC flow.
     *
     * Generated from protobuf field <code>bool use_pkce = 9 [json_name = "usePkce"];</code>
     */
