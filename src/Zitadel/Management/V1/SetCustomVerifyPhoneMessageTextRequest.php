...
/**
 * Generated from protobuf message <code>zitadel.management.v1.SetCustomVerifyPhoneMessageTextRequest</code>
 */
class SetCustomVerifyPhoneMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
