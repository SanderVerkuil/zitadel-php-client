...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateSAMLProviderRequest</code>
 */
class UpdateSAMLProviderRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.zitadel.idp.v1.SAMLBinding binding = 5 [json_name = "binding"];</code>
     */
    protected $binding = 0;
    /**
     * Boolean which defines if the authentication requests are signed.
     *
     * Generated from protobuf field <code>bool with_signed_request = 6 [json_name = "withSignedRequest"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .zitadel.idp.v1.SAMLNameIDFormat name_id_format = 8 [json_name = "nameIdFormat"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional string transient_mapping_attribute_name = 9 [json_name = "transientMappingAttributeName"];</code>
     */
     ...
     * Url to the metadata of the SAML identity provider.
     *
     * Generated from protobuf field <code>string metadata_url = 4 [json_name = "metadataUrl", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @return string
     */
