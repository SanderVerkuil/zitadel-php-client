...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateAPIAppConfigRequest</code>
 */
class UpdateAPIAppConfigRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $app_id = '';
    /**
     * Generated from protobuf field <code>.zitadel.app.v1.APIAuthMethodType auth_method_type = 7 [json_name = "authMethodType", (.validate.rules) = {</code>
     */
