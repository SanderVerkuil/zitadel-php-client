...
/**
 * Generated from protobuf message <code>zitadel.management.v1.DeactivateUserGrantResponse</code>
 */
class DeactivateUserGrantResponse extends \Google\Protobuf\Internal\Message
{
    /**
