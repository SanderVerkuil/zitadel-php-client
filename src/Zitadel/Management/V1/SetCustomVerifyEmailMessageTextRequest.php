...
/**
 * Generated from protobuf message <code>zitadel.management.v1.SetCustomVerifyEmailMessageTextRequest</code>
 */
class SetCustomVerifyEmailMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
