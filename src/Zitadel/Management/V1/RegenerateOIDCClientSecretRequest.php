...
/**
 * Generated from protobuf message <code>zitadel.management.v1.RegenerateOIDCClientSecretRequest</code>
 */
class RegenerateOIDCClientSecretRequest extends \Google\Protobuf\Internal\Message
{
    /**
