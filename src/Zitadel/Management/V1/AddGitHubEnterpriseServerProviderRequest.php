...
/**
 * Generated from protobuf message <code>zitadel.management.v1.AddGitHubEnterpriseServerProviderRequest</code>
 */
class AddGitHubEnterpriseServerProviderRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string authorization_endpoint = 4 [json_name = "authorizationEndpoint", (.validate.rules) = {</code>
     */
    protected $authorization_endpoint = '';
    /**
     * Generated from protobuf field <code>string token_endpoint = 5 [json_name = "tokenEndpoint", (.validate.rules) = {</code>
     */
    protected $token_endpoint = '';
    /**
     * Generated from protobuf field <code>string user_endpoint = 6 [json_name = "userEndpoint", (.validate.rules) = {</code>
     */
