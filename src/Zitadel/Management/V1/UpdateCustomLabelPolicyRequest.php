...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateCustomLabelPolicyRequest</code>
 */
class UpdateCustomLabelPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>string primary_color = 1 [json_name = "primaryColor", (.validate.rules) = {</code>
     */
