...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateOrgIDPJWTConfigRequest</code>
 */
class UpdateOrgIDPJWTConfigRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $idp_id = '';
    /**
     * Generated from protobuf field <code>string jwt_endpoint = 2 [json_name = "jwtEndpoint", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    protected $issuer = '';
    /**
     * Generated from protobuf field <code>string keys_endpoint = 4 [json_name = "keysEndpoint", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $keys_endpoint = '';
    /**
     * Generated from protobuf field <code>string header_name = 5 [json_name = "headerName", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
