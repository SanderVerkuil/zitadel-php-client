...
/**
 * Generated from protobuf message <code>zitadel.management.v1.SetCustomInitMessageTextRequest</code>
 */
class SetCustomInitMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
