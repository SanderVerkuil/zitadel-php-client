...
/**
 * Generated from protobuf message <code>zitadel.management.v1.ListAppsRequest</code>
 */
class ListAppsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .zitadel.app.v1.AppQuery queries = 3 [json_name = "queries"];</code>
     */
    private $queries;
     ...
     *          list limitations and ordering
     *     @type array<\Zitadel\App\V1\AppQuery>|\Google\Protobuf\Internal\RepeatedField $queries
     *          criteria the client is looking for
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .zitadel.app.v1.AppQuery queries = 3 [json_name = "queries"];</code>
     * @param array<\Zitadel\App\V1\AppQuery>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setQueries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\App\V1\AppQuery::class);
        $this->queries = $arr;
