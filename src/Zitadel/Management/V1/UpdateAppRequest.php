...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateAppRequest</code>
 */
class UpdateAppRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $app_id = '';
    /**
     * Generated from protobuf field <code>string name = 5 [json_name = "name", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $name = '';
