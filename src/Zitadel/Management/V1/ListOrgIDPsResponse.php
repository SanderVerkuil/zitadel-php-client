...
/**
 * Generated from protobuf message <code>zitadel.management.v1.ListOrgIDPsResponse</code>
 */
class ListOrgIDPsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.idp.v1.IDP result = 3 [json_name = "result"];</code>
     */
    private $result;
     ...
     *     @type array<\Zitadel\Idp\V1\IDP>|\Google\Protobuf\Internal\RepeatedField $result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.idp.v1.IDP result = 3 [json_name = "result"];</code>
     * @param array<\Zitadel\Idp\V1\IDP>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\Idp\V1\IDP::class);
        $this->result = $arr;
