...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateGitLabSelfHostedProviderRequest</code>
 */
class UpdateGitLabSelfHostedProviderRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>string issuer = 2 [json_name = "issuer", (.validate.rules) = {</code>
     */
    protected $issuer = '';
    /**
