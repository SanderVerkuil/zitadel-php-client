...
/**
 * Generated from protobuf message <code>zitadel.management.v1.SetCustomPasswordlessRegistrationMessageTextRequest</code>
 */
class SetCustomPasswordlessRegistrationMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
