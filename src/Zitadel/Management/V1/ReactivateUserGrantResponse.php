...
/**
 * Generated from protobuf message <code>zitadel.management.v1.ReactivateUserGrantResponse</code>
 */
class ReactivateUserGrantResponse extends \Google\Protobuf\Internal\Message
{
    /**
