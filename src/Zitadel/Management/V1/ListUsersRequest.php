...
/**
 * Generated from protobuf message <code>zitadel.management.v1.ListUsersRequest</code>
 */
class ListUsersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .zitadel.user.v1.SearchQuery queries = 3 [json_name = "queries"];</code>
     */
    private $queries;
