...
/**
 * Generated from protobuf message <code>zitadel.management.v1.AddGitLabSelfHostedProviderRequest</code>
 */
class AddGitLabSelfHostedProviderRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>string issuer = 1 [json_name = "issuer", (.validate.rules) = {</code>
     */
    protected $issuer = '';
    /**
