...
/**
 * Generated from protobuf message <code>zitadel.management.v1.UpdateGenericOAuthProviderRequest</code>
 */
class UpdateGenericOAuthProviderRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string authorization_endpoint = 5 [json_name = "authorizationEndpoint", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $authorization_endpoint = '';
    /**
     * Generated from protobuf field <code>string token_endpoint = 6 [json_name = "tokenEndpoint", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $token_endpoint = '';
    /**
     * Generated from protobuf field <code>string user_endpoint = 7 [json_name = "userEndpoint", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
     ...
     *
     * Generated from protobuf field <code>string id_attribute = 9 [json_name = "idAttribute", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $id_attribute = '';
    /**
     * Generated from protobuf field <code>.zitadel.idp.v1.Options provider_options = 10 [json_name = "providerOptions"];</code>
     */
    protected $provider_options = null;
    /**
     * Enable the use of Proof Key for Code Exchange (PKCE) for the OAuth2 flow.
     *
     * Generated from protobuf field <code>bool use_pkce = 11 [json_name = "usePkce"];</code>
     */
