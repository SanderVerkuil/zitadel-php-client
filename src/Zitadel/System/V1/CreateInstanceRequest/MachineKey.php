...
/**
 * Generated from protobuf message <code>zitadel.system.v1.CreateInstanceRequest.MachineKey</code>
 */
class MachineKey extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.zitadel.authn.v1.KeyType type = 1 [json_name = "type", (.validate.rules) = {</code>
     */
    protected $type = 0;
    /**
