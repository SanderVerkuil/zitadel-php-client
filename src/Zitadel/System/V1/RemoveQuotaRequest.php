...
/**
 * Generated from protobuf message <code>zitadel.system.v1.RemoveQuotaRequest</code>
 */
class RemoveQuotaRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.zitadel.quota.v1.Unit unit = 2 [json_name = "unit"];</code>
     */
    protected $unit = 0;
