...
/**
 * Generated from protobuf message <code>zitadel.settings.v2beta.SetSecuritySettingsResponse</code>
 */
class SetSecuritySettingsResponse extends \Google\Protobuf\Internal\Message
{
    /**
