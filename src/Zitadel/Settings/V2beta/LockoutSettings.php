...
/**
 * Generated from protobuf message <code>zitadel.settings.v2beta.LockoutSettings</code>
 */
class LockoutSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.zitadel.settings.v2beta.ResourceOwnerType resource_owner_type = 2 [json_name = "resourceOwnerType", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Zitadel\Settings\V2Beta\LockoutSettings::initOnce();
