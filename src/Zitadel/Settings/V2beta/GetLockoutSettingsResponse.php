...
/**
 * Generated from protobuf message <code>zitadel.settings.v2beta.GetLockoutSettingsResponse</code>
 */
class GetLockoutSettingsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2beta.LockoutSettings settings = 2 [json_name = "settings"];</code>
     */
     ...
     *     @type \Zitadel\Settings\V2beta\LockoutSettings $settings
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2beta.LockoutSettings settings = 2 [json_name = "settings"];</code>
     * @return \Zitadel\Settings\V2beta\LockoutSettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2beta.LockoutSettings settings = 2 [json_name = "settings"];</code>
     * @param \Zitadel\Settings\V2beta\LockoutSettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Settings\V2beta\LockoutSettings::class);
        $this->settings = $var;
