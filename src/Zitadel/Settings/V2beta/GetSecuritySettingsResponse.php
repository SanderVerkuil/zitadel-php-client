...
/**
 * Generated from protobuf message <code>zitadel.settings.v2beta.GetSecuritySettingsResponse</code>
 */
class GetSecuritySettingsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2beta.SecuritySettings settings = 2 [json_name = "settings"];</code>
     */
     ...
     *     @type \Zitadel\Settings\V2beta\SecuritySettings $settings
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2beta.SecuritySettings settings = 2 [json_name = "settings"];</code>
     * @return \Zitadel\Settings\V2beta\SecuritySettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2beta.SecuritySettings settings = 2 [json_name = "settings"];</code>
     * @param \Zitadel\Settings\V2beta\SecuritySettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Settings\V2beta\SecuritySettings::class);
        $this->settings = $var;
