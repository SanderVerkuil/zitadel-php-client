...
/**
 * Generated from protobuf message <code>zitadel.settings.v2.GetDomainSettingsResponse</code>
 */
class GetDomainSettingsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.DomainSettings settings = 2 [json_name = "settings"];</code>
     */
     ...
     *     @type \Zitadel\Settings\V2\DomainSettings $settings
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.DomainSettings settings = 2 [json_name = "settings"];</code>
     * @return \Zitadel\Settings\V2\DomainSettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.DomainSettings settings = 2 [json_name = "settings"];</code>
     * @param \Zitadel\Settings\V2\DomainSettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Settings\V2\DomainSettings::class);
        $this->settings = $var;
