...
/**
 * Generated from protobuf message <code>zitadel.settings.v2.GetLoginSettingsResponse</code>
 */
class GetLoginSettingsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.LoginSettings settings = 2 [json_name = "settings"];</code>
     */
     ...
     *     @type \Zitadel\Settings\V2\LoginSettings $settings
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.LoginSettings settings = 2 [json_name = "settings"];</code>
     * @return \Zitadel\Settings\V2\LoginSettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.LoginSettings settings = 2 [json_name = "settings"];</code>
     * @param \Zitadel\Settings\V2\LoginSettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Settings\V2\LoginSettings::class);
        $this->settings = $var;
