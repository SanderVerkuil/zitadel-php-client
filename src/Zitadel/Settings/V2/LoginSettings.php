...
/**
 * Generated from protobuf message <code>zitadel.settings.v2.LoginSettings</code>
 */
class LoginSettings extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.PasskeysType passkeys_type = 5 [json_name = "passkeysType", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.settings.v2.SecondFactorType second_factors = 14 [json_name = "secondFactors"];</code>
     */
    private $second_factors;
    /**
     * Generated from protobuf field <code>repeated .zitadel.settings.v2.MultiFactorType multi_factors = 15 [json_name = "multiFactors"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.settings.v2.ResourceOwnerType resource_owner_type = 19 [json_name = "resourceOwnerType", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Zitadel\Settings\V2\PasskeysType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Zitadel\Settings\V2\SecondFactorType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Zitadel\Settings\V2\MultiFactorType::class);
