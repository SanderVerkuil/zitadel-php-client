...
/**
 * Generated from protobuf message <code>zitadel.settings.v2.SetSecuritySettingsRequest</code>
 */
class SetSecuritySettingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.EmbeddedIframeSettings embedded_iframe = 1 [json_name = "embeddedIframe"];</code>
     */
     ...
     *
     *     @type \Zitadel\Settings\V2\EmbeddedIframeSettings $embedded_iframe
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.EmbeddedIframeSettings embedded_iframe = 1 [json_name = "embeddedIframe"];</code>
     * @return \Zitadel\Settings\V2\EmbeddedIframeSettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.settings.v2.EmbeddedIframeSettings embedded_iframe = 1 [json_name = "embeddedIframe"];</code>
     * @param \Zitadel\Settings\V2\EmbeddedIframeSettings $var
     * @return $this
     */
    public function setEmbeddedIframe($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Settings\V2\EmbeddedIframeSettings::class);
