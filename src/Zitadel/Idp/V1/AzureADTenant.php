...
/**
 * Generated from protobuf message <code>zitadel.idp.v1.AzureADTenant</code>
 */
class AzureADTenant extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.idp.v1.AzureADTenantType tenant_type = 1 [json_name = "tenantType"];</code>
     * @return int
     */
    ...
    {
        GPBUtil::checkEnum($var, \Zitadel\Idp\V1\AzureADTenantType::class);
