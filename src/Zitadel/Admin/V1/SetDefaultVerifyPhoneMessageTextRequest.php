...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultVerifyPhoneMessageTextRequest</code>
 */
class SetDefaultVerifyPhoneMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
