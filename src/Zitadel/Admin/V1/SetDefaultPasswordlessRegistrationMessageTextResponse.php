...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultPasswordlessRegistrationMessageTextResponse</code>
 */
class SetDefaultPasswordlessRegistrationMessageTextResponse extends \Google\Protobuf\Internal\Message
{
    /**
