...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultPasswordlessRegistrationMessageTextRequest</code>
 */
class SetDefaultPasswordlessRegistrationMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
