...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.ListIDPsRequest</code>
 */
class ListIDPsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .zitadel.admin.v1.IDPQuery queries = 3 [json_name = "queries"];</code>
     */
    private $queries;
     ...
     *           the field the result is sorted
     *     @type array<\Zitadel\Admin\V1\IDPQuery>|\Google\Protobuf\Internal\RepeatedField $queries
     *          criteria the client is looking for
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .zitadel.admin.v1.IDPQuery queries = 3 [json_name = "queries"];</code>
     * @param array<\Zitadel\Admin\V1\IDPQuery>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setQueries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\Admin\V1\IDPQuery::class);
        $this->queries = $arr;
