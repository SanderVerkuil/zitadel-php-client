...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultPasswordChangeMessageTextRequest</code>
 */
class SetDefaultPasswordChangeMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
