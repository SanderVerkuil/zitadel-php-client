...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.UpdatePasswordAgePolicyResponse</code>
 */
class UpdatePasswordAgePolicyResponse extends \Google\Protobuf\Internal\Message
{
    /**
