...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultVerifyEmailMessageTextRequest</code>
 */
class SetDefaultVerifyEmailMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
