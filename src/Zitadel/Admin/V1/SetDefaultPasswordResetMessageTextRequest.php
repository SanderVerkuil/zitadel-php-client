...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultPasswordResetMessageTextRequest</code>
 */
class SetDefaultPasswordResetMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
