...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.DeactivateSMTPConfigResponse</code>
 */
class DeactivateSMTPConfigResponse extends \Google\Protobuf\Internal\Message
{
    /**
