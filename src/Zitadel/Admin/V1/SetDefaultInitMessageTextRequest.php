...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultInitMessageTextRequest</code>
 */
class SetDefaultInitMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
