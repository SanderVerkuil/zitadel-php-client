...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultVerifyEmailOTPMessageTextRequest</code>
 */
class SetDefaultVerifyEmailOTPMessageTextRequest extends \Google\Protobuf\Internal\Message
{
    /**
