...
/**
 * Generated from protobuf message <code>zitadel.admin.v1.SetDefaultInitMessageTextResponse</code>
 */
class SetDefaultInitMessageTextResponse extends \Google\Protobuf\Internal\Message
{
    /**
