...
/**
 * Generated from protobuf message <code>zitadel.text.v1.InitializeUserScreenText</code>
 */
class InitializeUserScreenText extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string resend_button_text = 6 [json_name = "resendButtonText", (.validate.rules) = {</code>
     */
