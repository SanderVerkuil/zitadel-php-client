...
/**
 * Generated from protobuf message <code>zitadel.text.v1.EmailVerificationScreenText</code>
 */
class EmailVerificationScreenText extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string resend_button_text = 5 [json_name = "resendButtonText", (.validate.rules) = {</code>
     */
