...
/**
 * Generated from protobuf message <code>zitadel.text.v1.InitializeUserDoneScreenText</code>
 */
class InitializeUserDoneScreenText extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string cancel_button_text = 3 [json_name = "cancelButtonText", (.validate.rules) = {</code>
     */
