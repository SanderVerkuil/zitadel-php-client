...
/**
 * Generated from protobuf message <code>zitadel.user.v2.AddHumanUserRequest</code>
 */
class AddHumanUserRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.object.v2.Organization organization = 11 [json_name = "organization"];</code>
     */
    protected $organization = null;
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.SetHumanProfile profile = 4 [json_name = "profile", (.google.api.field_behavior) = REQUIRED, (.validate.rules) = {</code>
     */
    protected $profile = null;
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.SetHumanEmail email = 5 [json_name = "email", (.google.api.field_behavior) = REQUIRED, (.validate.rules) = {</code>
     */
    protected $email = null;
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.SetHumanPhone phone = 10 [json_name = "phone"];</code>
     */
    protected $phone = null;
    /**
     * Generated from protobuf field <code>repeated .zitadel.user.v2.SetMetadataEntry metadata = 6 [json_name = "metadata"];</code>
     */
    private $metadata;
    /**
     * Generated from protobuf field <code>repeated .zitadel.user.v2.IDPLink idp_links = 9 [json_name = "idpLinks"];</code>
     */
    private $idp_links;
    /**
     ...
     *           optionally set a unique username, if none is provided the email will be used.
     *     @type \Zitadel\Object\V2\Organization $organization
     ...
     *     @type array<\Zitadel\User\V2\SetMetadataEntry>|\Google\Protobuf\Internal\RepeatedField $metadata
     *     @type \Zitadel\User\V2\Password $password
     *     @type \Zitadel\User\V2\HashedPassword $hashed_password
     *     @type array<\Zitadel\User\V2\IDPLink>|\Google\Protobuf\Internal\RepeatedField $idp_links
    ...
    /**
     * Generated from protobuf field <code>.zitadel.object.v2.Organization organization = 11 [json_name = "organization"];</code>
     * @return \Zitadel\Object\V2\Organization|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.object.v2.Organization organization = 11 [json_name = "organization"];</code>
     * @param \Zitadel\Object\V2\Organization $var
     * @return $this
     */
    public function setOrganization($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Object\V2\Organization::class);
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.user.v2.SetMetadataEntry metadata = 6 [json_name = "metadata"];</code>
     * @param array<\Zitadel\User\V2\SetMetadataEntry>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMetadata($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\User\V2\SetMetadataEntry::class);
        $this->metadata = $arr;
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.Password password = 7 [json_name = "password"];</code>
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.HashedPassword hashed_password = 8 [json_name = "hashedPassword"];</code>
     * @return \Zitadel\User\V2\HashedPassword|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.HashedPassword hashed_password = 8 [json_name = "hashedPassword"];</code>
     * @param \Zitadel\User\V2\HashedPassword $var
     * @return $this
     */
    public function setHashedPassword($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2\HashedPassword::class);
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.user.v2.IDPLink idp_links = 9 [json_name = "idpLinks"];</code>
     * @param array<\Zitadel\User\V2\IDPLink>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setIdpLinks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\User\V2\IDPLink::class);
        $this->idp_links = $arr;
