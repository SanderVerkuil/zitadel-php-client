...
/**
 * Generated from protobuf message <code>zitadel.user.v2.MachineUser</code>
 */
class MachineUser extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.AccessTokenType access_token_type = 4 [json_name = "accessTokenType", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Zitadel\User\V2\AccessTokenType::class);
