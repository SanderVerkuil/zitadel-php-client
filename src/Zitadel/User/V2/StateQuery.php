 ...
 *
 * Generated from protobuf message <code>zitadel.user.v2.StateQuery</code>
 */
class StateQuery extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.UserState state = 1 [json_name = "state", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $state = 0;
