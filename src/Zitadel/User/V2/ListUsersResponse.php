...
/**
 * Generated from protobuf message <code>zitadel.user.v2.ListUsersResponse</code>
 */
class ListUsersResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.user.v2.User result = 3 [json_name = "result"];</code>
     */
    private $result;
     ...
     *     @type array<\Zitadel\User\V2\User>|\Google\Protobuf\Internal\RepeatedField $result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .zitadel.user.v2.User result = 3 [json_name = "result"];</code>
     * @param array<\Zitadel\User\V2\User>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\User\V2\User::class);
        $this->result = $arr;
