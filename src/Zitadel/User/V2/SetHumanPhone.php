...
/**
 * Generated from protobuf message <code>zitadel.user.v2.SetHumanPhone</code>
 */
class SetHumanPhone extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.SendPhoneVerificationCode send_code = 2 [json_name = "sendCode"];</code>
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2.ReturnPhoneVerificationCode return_code = 3 [json_name = "returnCode"];</code>
