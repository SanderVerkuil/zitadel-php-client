...
/**
 * Generated from protobuf message <code>zitadel.user.v1.UserGrantOrgDomainQuery</code>
 */
class UserGrantOrgDomainQuery extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>string org_domain = 1 [json_name = "orgDomain", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
