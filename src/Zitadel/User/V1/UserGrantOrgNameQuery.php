...
/**
 * Generated from protobuf message <code>zitadel.user.v1.UserGrantOrgNameQuery</code>
 */
class UserGrantOrgNameQuery extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>string org_name = 1 [json_name = "orgName", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $org_name = '';
    /**
