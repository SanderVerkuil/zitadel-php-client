...
/**
 * Generated from protobuf message <code>zitadel.user.v1.UserGrantProjectNameQuery</code>
 */
class UserGrantProjectNameQuery extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>string project_name = 1 [json_name = "projectName", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
