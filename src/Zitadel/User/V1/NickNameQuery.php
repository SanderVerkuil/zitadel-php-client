...
/**
 * Generated from protobuf message <code>zitadel.user.v1.NickNameQuery</code>
 */
class NickNameQuery extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>string nick_name = 1 [json_name = "nickName", (.validate.rules) = {</code>
     */
    protected $nick_name = '';
    /**
