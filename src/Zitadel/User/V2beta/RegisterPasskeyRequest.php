...
/**
 * Generated from protobuf message <code>zitadel.user.v2beta.RegisterPasskeyRequest</code>
 */
class RegisterPasskeyRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $code = null;
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.PasskeyAuthenticator authenticator = 3 [json_name = "authenticator", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Zitadel\User\V2beta\PasskeyAuthenticator::class);
