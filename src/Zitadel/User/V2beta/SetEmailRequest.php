...
/**
 * Generated from protobuf message <code>zitadel.user.v2beta.SetEmailRequest</code>
 */
class SetEmailRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.SendEmailVerificationCode send_code = 3 [json_name = "sendCode"];</code>
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.ReturnEmailVerificationCode return_code = 4 [json_name = "returnCode"];</code>
