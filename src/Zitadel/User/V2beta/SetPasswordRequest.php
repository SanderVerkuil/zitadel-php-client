...
/**
 * Generated from protobuf message <code>zitadel.user.v2beta.SetPasswordRequest</code>
 */
class SetPasswordRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $user_id = '';
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.Password new_password = 2 [json_name = "newPassword"];</code>
     */
     ...
     *
     *     @type string $user_id
     *     @type \Zitadel\User\V2beta\Password $new_password
