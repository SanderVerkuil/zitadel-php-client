...
/**
 * Generated from protobuf message <code>zitadel.user.v2beta.IDPInformation</code>
 */
class IDPInformation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Zitadel\User\V2beta\IDPOAuthAccessInformation $oauth
     *     @type \Zitadel\User\V2beta\IDPLDAPAccessInformation $ldap
     *     @type \Zitadel\User\V2beta\IDPSAMLAccessInformation $saml
     *     @type string $idp_id
     *     @type string $user_id
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.IDPOAuthAccessInformation oauth = 1 [json_name = "oauth", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @return \Zitadel\User\V2beta\IDPOAuthAccessInformation|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.IDPOAuthAccessInformation oauth = 1 [json_name = "oauth", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @param \Zitadel\User\V2beta\IDPOAuthAccessInformation $var
     * @return $this
     */
    public function setOauth($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\IDPOAuthAccessInformation::class);
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.IDPLDAPAccessInformation ldap = 6 [json_name = "ldap", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @return \Zitadel\User\V2beta\IDPLDAPAccessInformation|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.IDPLDAPAccessInformation ldap = 6 [json_name = "ldap", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @param \Zitadel\User\V2beta\IDPLDAPAccessInformation $var
     * @return $this
     */
    public function setLdap($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\IDPLDAPAccessInformation::class);
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.IDPSAMLAccessInformation saml = 7 [json_name = "saml", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @return \Zitadel\User\V2beta\IDPSAMLAccessInformation|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.IDPSAMLAccessInformation saml = 7 [json_name = "saml", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @param \Zitadel\User\V2beta\IDPSAMLAccessInformation $var
     * @return $this
     */
    public function setSaml($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\IDPSAMLAccessInformation::class);
