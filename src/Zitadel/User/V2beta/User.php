...
/**
 * Generated from protobuf message <code>zitadel.user.v2beta.User</code>
 */
class User extends \Google\Protobuf\Internal\Message
{
    ...
    protected $user_id = '';
    /**
     * Generated from protobuf field <code>.zitadel.object.v2beta.Details details = 8 [json_name = "details"];</code>
     */
     ...
     *     @type \Zitadel\User\V2beta\HumanUser $human
     *     @type \Zitadel\User\V2beta\MachineUser $machine
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanUser human = 6 [json_name = "human", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @return \Zitadel\User\V2beta\HumanUser|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanUser human = 6 [json_name = "human", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @param \Zitadel\User\V2beta\HumanUser $var
     * @return $this
     */
    public function setHuman($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\HumanUser::class);
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.MachineUser machine = 7 [json_name = "machine", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @return \Zitadel\User\V2beta\MachineUser|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.user.v2beta.MachineUser machine = 7 [json_name = "machine", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     * @param \Zitadel\User\V2beta\MachineUser $var
     * @return $this
     */
    public function setMachine($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\MachineUser::class);
