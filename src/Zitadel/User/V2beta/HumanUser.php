...
/**
 * Generated from protobuf message <code>zitadel.user.v2beta.HumanUser</code>
 */
class HumanUser extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.UserState state = 2 [json_name = "state", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanProfile profile = 6 [json_name = "profile"];</code>
     */
    protected $profile = null;
    /**
     * Email of the user, if defined.
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanEmail email = 7 [json_name = "email"];</code>
     */
    protected $email = null;
    /**
     * Phone of the user, if defined.
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanPhone phone = 8 [json_name = "phone"];</code>
     */
     ...
     *           Preferred login name of the user.
     *     @type \Zitadel\User\V2beta\HumanProfile $profile
     *           Profile information of the user.
     *     @type \Zitadel\User\V2beta\HumanEmail $email
     *           Email of the user, if defined.
     *     @type \Zitadel\User\V2beta\HumanPhone $phone
     *           Phone of the user, if defined.
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanProfile profile = 6 [json_name = "profile"];</code>
     * @return \Zitadel\User\V2beta\HumanProfile|null
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanProfile profile = 6 [json_name = "profile"];</code>
     * @param \Zitadel\User\V2beta\HumanProfile $var
     * @return $this
     */
    public function setProfile($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\HumanProfile::class);
        $this->profile = $var;
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanEmail email = 7 [json_name = "email"];</code>
     * @return \Zitadel\User\V2beta\HumanEmail|null
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanEmail email = 7 [json_name = "email"];</code>
     * @param \Zitadel\User\V2beta\HumanEmail $var
     * @return $this
     */
    public function setEmail($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\HumanEmail::class);
        $this->email = $var;
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanPhone phone = 8 [json_name = "phone"];</code>
     * @return \Zitadel\User\V2beta\HumanPhone|null
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.user.v2beta.HumanPhone phone = 8 [json_name = "phone"];</code>
     * @param \Zitadel\User\V2beta\HumanPhone $var
     * @return $this
     */
    public function setPhone($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\User\V2beta\HumanPhone::class);
        $this->phone = $var;
