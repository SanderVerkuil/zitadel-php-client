...
/**
 * Generated from protobuf message <code>zitadel.session.v2.SetSessionResponse</code>
 */
class SetSessionResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.zitadel.session.v2.Challenges challenges = 3 [json_name = "challenges"];</code>
     */
