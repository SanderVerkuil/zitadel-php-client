...
/**
 * Generated from protobuf message <code>zitadel.resources.action.v3alpha.PatchTargetResponse</code>
 */
class PatchTargetResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>optional string signing_key = 2 [json_name = "signingKey", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    ...
    {
        return isset($this->signing_key) ? $this->signing_key : '';
    }
