...
/**
 * Generated from protobuf message <code>zitadel.resources.action.v3alpha.SearchTargetsRequest</code>
 */
class SearchTargetsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>optional .zitadel.resources.action.v3alpha.TargetFieldName sorting_column = 3 [json_name = "sortingColumn", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $sorting_column = null;
    /**
     * Define the criteria to query for.
     *
     * Generated from protobuf field <code>repeated .zitadel.resources.action.v3alpha.TargetSearchFilter filters = 4 [json_name = "filters"];</code>
     */
    private $filters;
     ...
     *           The field the result is sorted by. The default is the creation date. Beware that if you change this, your result pagination might be inconsistent.
     *     @type array<\Zitadel\Resources\Action\V3alpha\TargetSearchFilter>|\Google\Protobuf\Internal\RepeatedField $filters
     *           Define the criteria to query for.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Zitadel\Resources\Action\V3alpha\TargetFieldName::class);
     ...
     *
     * Generated from protobuf field <code>repeated .zitadel.resources.action.v3alpha.TargetSearchFilter filters = 4 [json_name = "filters"];</code>
     * @param array<\Zitadel\Resources\Action\V3alpha\TargetSearchFilter>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFilters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Zitadel\Resources\Action\V3alpha\TargetSearchFilter::class);
        $this->filters = $arr;
