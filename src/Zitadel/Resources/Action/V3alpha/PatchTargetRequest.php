...
/**
 * Generated from protobuf message <code>zitadel.resources.action.v3alpha.PatchTargetRequest</code>
 */
class PatchTargetRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>.zitadel.resources.action.v3alpha.PatchTarget target = 3 [json_name = "target", (.validate.rules) = {</code>
     */
     ...
     *     @type string $id
     *     @type \Zitadel\Resources\Action\V3alpha\PatchTarget $target
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.resources.action.v3alpha.PatchTarget target = 3 [json_name = "target", (.validate.rules) = {</code>
     * @return \Zitadel\Resources\Action\V3alpha\PatchTarget|null
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.resources.action.v3alpha.PatchTarget target = 3 [json_name = "target", (.validate.rules) = {</code>
     * @param \Zitadel\Resources\Action\V3alpha\PatchTarget $var
     * @return $this
     */
    public function setTarget($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Resources\Action\V3alpha\PatchTarget::class);
        $this->target = $var;
