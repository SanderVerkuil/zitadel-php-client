...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveOTPEmailAuthenticatorResponse</code>
 */
class RemoveOTPEmailAuthenticatorResponse extends \Google\Protobuf\Internal\Message
{
    /**
