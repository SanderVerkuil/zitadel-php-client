...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.AddIDPAuthenticatorRequest</code>
 */
class AddIDPAuthenticatorRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $id = '';
    /**
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.IDPAuthenticator authenticator = 4 [json_name = "authenticator"];</code>
     */
     ...
     *     @type string $id
     *           unique identifier of the user.
     *     @type \Zitadel\Resources\User\V3alpha\IDPAuthenticator $authenticator
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.IDPAuthenticator authenticator = 4 [json_name = "authenticator"];</code>
     * @return \Zitadel\Resources\User\V3alpha\IDPAuthenticator|null
     */
    ...
    {
        return isset($this->authenticator);
    }

    public function clearAuthenticator()
    {
    ...
    /**
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.IDPAuthenticator authenticator = 4 [json_name = "authenticator"];</code>
     * @param \Zitadel\Resources\User\V3alpha\IDPAuthenticator $var
     * @return $this
     */
    public function setAuthenticator($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Resources\User\V3alpha\IDPAuthenticator::class);
