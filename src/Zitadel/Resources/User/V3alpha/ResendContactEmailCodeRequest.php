...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.ResendContactEmailCodeRequest</code>
 */
class ResendContactEmailCodeRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * Let ZITADEL send the link to the user via email.
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SendEmailVerificationCode send_code = 4 [json_name = "sendCode"];</code>
     ...
     * Get the code back to provide it to the user in your preferred mechanism.
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.ReturnEmailVerificationCode return_code = 5 [json_name = "returnCode"];</code>
