...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.AddIDPAuthenticatorResponse</code>
 */
class AddIDPAuthenticatorResponse extends \Google\Protobuf\Internal\Message
{
    /**
