...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RequestPasswordResetResponse</code>
 */
class RequestPasswordResetResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>optional string verification_code = 2 [json_name = "verificationCode", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
