...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.VerifyOTPEmailRegistrationRequest</code>
 */
class VerifyOTPEmailRegistrationRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string otp_email_id = 4 [json_name = "otpEmailId", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $otp_email_id = '';
    /**
     * Set the verification code generated during the add OTP Email request.
     *
     * Generated from protobuf field <code>string code = 5 [json_name = "code", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $code = '';
