...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveOTPEmailAuthenticatorRequest</code>
 */
class RemoveOTPEmailAuthenticatorRequest extends \Google\Protobuf\Internal\Message
{
    /**
