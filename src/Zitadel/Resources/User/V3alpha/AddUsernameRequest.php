...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.AddUsernameRequest</code>
 */
class AddUsernameRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SetUsername username = 4 [json_name = "username"];</code>
     */
     ...
     *     @type string $id
     *           unique identifier of the user.
     *     @type \Zitadel\Resources\User\V3alpha\SetUsername $username
     *           Set the user's new username.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SetUsername username = 4 [json_name = "username"];</code>
     * @return \Zitadel\Resources\User\V3alpha\SetUsername|null
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SetUsername username = 4 [json_name = "username"];</code>
     * @param \Zitadel\Resources\User\V3alpha\SetUsername $var
     * @return $this
     */
    public function setUsername($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Resources\User\V3alpha\SetUsername::class);
        $this->username = $var;
