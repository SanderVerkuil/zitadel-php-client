...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveUsernameRequest</code>
 */
class RemoveUsernameRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string username_id = 4 [json_name = "usernameId", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
