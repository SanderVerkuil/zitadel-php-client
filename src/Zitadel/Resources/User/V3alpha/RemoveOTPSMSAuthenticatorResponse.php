...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveOTPSMSAuthenticatorResponse</code>
 */
class RemoveOTPSMSAuthenticatorResponse extends \Google\Protobuf\Internal\Message
{
    /**
