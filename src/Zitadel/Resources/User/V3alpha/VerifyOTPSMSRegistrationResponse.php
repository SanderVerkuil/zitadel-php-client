...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.VerifyOTPSMSRegistrationResponse</code>
 */
class VerifyOTPSMSRegistrationResponse extends \Google\Protobuf\Internal\Message
{
    /**
