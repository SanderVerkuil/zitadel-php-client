...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.StartTOTPRegistrationRequest</code>
 */
class StartTOTPRegistrationRequest extends \Google\Protobuf\Internal\Message
{
    /**
