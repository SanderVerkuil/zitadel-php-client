...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.AddOTPSMSAuthenticatorResponse</code>
 */
class AddOTPSMSAuthenticatorResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string otp_sms_id = 2 [json_name = "otpSmsId", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
