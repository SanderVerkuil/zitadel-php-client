...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveWebAuthNAuthenticatorResponse</code>
 */
class RemoveWebAuthNAuthenticatorResponse extends \Google\Protobuf\Internal\Message
{
    /**
