...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveIDPAuthenticatorRequest</code>
 */
class RemoveIDPAuthenticatorRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string idp_id = 4 [json_name = "idpId", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $idp_id = '';
