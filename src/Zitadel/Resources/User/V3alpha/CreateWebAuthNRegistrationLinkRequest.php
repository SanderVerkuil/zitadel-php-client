...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.CreateWebAuthNRegistrationLinkRequest</code>
 */
class CreateWebAuthNRegistrationLinkRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $id
     *           unique identifier of the user.
     *     @type \Zitadel\Resources\User\V3alpha\SendWebAuthNRegistrationLink $send_link
     *           Let ZITADEL send the link to the user via email.
     *     @type \Zitadel\Resources\User\V3alpha\ReturnWebAuthNRegistrationCode $return_code
     ...
     * Let ZITADEL send the link to the user via email.
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SendWebAuthNRegistrationLink send_link = 4 [json_name = "sendLink"];</code>
     * @return \Zitadel\Resources\User\V3alpha\SendWebAuthNRegistrationLink|null
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SendWebAuthNRegistrationLink send_link = 4 [json_name = "sendLink"];</code>
     * @param \Zitadel\Resources\User\V3alpha\SendWebAuthNRegistrationLink $var
     * @return $this
     */
    public function setSendLink($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Resources\User\V3alpha\SendWebAuthNRegistrationLink::class);
     ...
     * Get the code back to provide it to the user in your preferred mechanism.
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.ReturnWebAuthNRegistrationCode return_code = 5 [json_name = "returnCode"];</code>
     * @return \Zitadel\Resources\User\V3alpha\ReturnWebAuthNRegistrationCode|null
     */
     ...
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.ReturnWebAuthNRegistrationCode return_code = 5 [json_name = "returnCode"];</code>
     * @param \Zitadel\Resources\User\V3alpha\ReturnWebAuthNRegistrationCode $var
     * @return $this
     */
    public function setReturnCode($var)
    {
        GPBUtil::checkMessage($var, \Zitadel\Resources\User\V3alpha\ReturnWebAuthNRegistrationCode::class);
