...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.VerifyContactPhoneResponse</code>
 */
class VerifyContactPhoneResponse extends \Google\Protobuf\Internal\Message
{
    /**
