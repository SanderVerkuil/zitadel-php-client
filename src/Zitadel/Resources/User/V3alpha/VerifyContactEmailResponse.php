...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.VerifyContactEmailResponse</code>
 */
class VerifyContactEmailResponse extends \Google\Protobuf\Internal\Message
{
    /**
