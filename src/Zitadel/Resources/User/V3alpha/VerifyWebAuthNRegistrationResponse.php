...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.VerifyWebAuthNRegistrationResponse</code>
 */
class VerifyWebAuthNRegistrationResponse extends \Google\Protobuf\Internal\Message
{
    /**
