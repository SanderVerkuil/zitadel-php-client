...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.ActivateUserRequest</code>
 */
class ActivateUserRequest extends \Google\Protobuf\Internal\Message
{
    /**
