...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.RemoveIDPAuthenticatorResponse</code>
 */
class RemoveIDPAuthenticatorResponse extends \Google\Protobuf\Internal\Message
{
    /**
