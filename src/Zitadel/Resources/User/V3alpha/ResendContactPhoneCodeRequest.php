...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.ResendContactPhoneCodeRequest</code>
 */
class ResendContactPhoneCodeRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * Let ZITADEL send the link to the user via SMS.
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.SendPhoneVerificationCode send_code = 4 [json_name = "sendCode"];</code>
     ...
     * Get the code back to provide it to the user in your preferred mechanism.
     *
     * Generated from protobuf field <code>.zitadel.resources.user.v3alpha.ReturnPhoneVerificationCode return_code = 5 [json_name = "returnCode"];</code>
