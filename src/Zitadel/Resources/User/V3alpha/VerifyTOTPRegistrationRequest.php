...
/**
 * Generated from protobuf message <code>zitadel.resources.user.v3alpha.VerifyTOTPRegistrationRequest</code>
 */
class VerifyTOTPRegistrationRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string totp_id = 4 [json_name = "totpId", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $totp_id = '';
    /**
