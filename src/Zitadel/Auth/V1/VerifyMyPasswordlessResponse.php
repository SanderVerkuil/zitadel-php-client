...
/**
 * Generated from protobuf message <code>zitadel.auth.v1.VerifyMyPasswordlessResponse</code>
 */
class VerifyMyPasswordlessResponse extends \Google\Protobuf\Internal\Message
{
    /**
