...
/**
 * Generated from protobuf message <code>zitadel.auth.v1.RemoveMyPasswordlessResponse</code>
 */
class RemoveMyPasswordlessResponse extends \Google\Protobuf\Internal\Message
{
    /**
